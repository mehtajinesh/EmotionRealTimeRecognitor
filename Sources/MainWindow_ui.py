"""
File Name: MainWindow_ui.py
Author: Jinesh Mehta
File Description: This file contains the UI code for the main window of the application.
    """
# -*- coding: utf-8 -*-
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitterRealTimeLabelOthers.setObjectName(
            u"splitterRealTimeLabelOthers")
        ...
        self.horizontalLayoutRealTimeLabel = QHBoxLayout(
            self.horizontalLayoutWidget)
        self.horizontalLayoutRealTimeLabel.setObjectName(
            u"horizontalLayoutRealTimeLabel")
        self.horizontalLayoutRealTimeLabel.setContentsMargins(0, 0, 0, 0)
        self.horizontalSpacerLeftRealTime = QSpacerItem(
            40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayoutRealTimeLabel.addItem(
            self.horizontalSpacerLeftRealTime)

        self.labelRealTimeEmotionRecognition = QLabel(
            self.horizontalLayoutWidget)
        self.labelRealTimeEmotionRecognition.setObjectName(
            u"labelRealTimeEmotionRecognition")
        font = QFont()
        ...
        self.labelRealTimeEmotionRecognition.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter)

        self.horizontalLayoutRealTimeLabel.addWidget(
            self.labelRealTimeEmotionRecognition)

        self.horizontalSpacerRightRealTime = QSpacerItem(
            40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayoutRealTimeLabel.addItem(
            self.horizontalSpacerRightRealTime)

        self.splitterRealTimeLabelOthers.addWidget(self.horizontalLayoutWidget)
        self.splitterLiveVideoOthers = QSplitter(
            self.splitterRealTimeLabelOthers)
        ...
        self.splitterModelSelectionOutput = QSplitter(
            self.splitterLiveVideoOthers)
        self.splitterModelSelectionOutput.setObjectName(
            u"splitterModelSelectionOutput")
        self.splitterModelSelectionOutput.setOrientation(Qt.Vertical)
        self.groupBoxModelSelection = QGroupBox(
            self.splitterModelSelectionOutput)
        self.groupBoxModelSelection.setObjectName(u"groupBoxModelSelection")
        self.horizontalLayout_3 = QHBoxLayout(self.groupBoxModelSelection)
        ...
        self.horizontalLayout_3.addWidget(self.labelModelSelection)
        ...
        self.horizontalLayout_3.addWidget(self.comboBoxModelSelection)

        self.horizontalSpacerEndModelSelection = QSpacerItem(
            47, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_3.addItem(self.horizontalSpacerEndModelSelection)

        self.splitterModelSelectionOutput.addWidget(
            self.groupBoxModelSelection)
        ...
        self.horizontalLayoutDetectedEmoji.setObjectName(
            u"horizontalLayoutDetectedEmoji")
        ...
        self.horizontalLayoutDetectedEmoji.addWidget(
            self.labelDetectedEmojiPhoto)

        self.horizontalSpacerEndEmoji = QSpacerItem(
            40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayoutDetectedEmoji.addItem(
            self.horizontalSpacerEndEmoji)
        ...
        self.splitterLiveVideoOthers.addWidget(
            self.splitterModelSelectionOutput)
        self.splitterRealTimeLabelOthers.addWidget(
            self.splitterLiveVideoOthers)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate(
            "MainWindow", u"Real Time Emotion Recognition", None))
        self.labelRealTimeEmotionRecognition.setText(QCoreApplication.translate(
            "MainWindow", u"Real Time Emotion Recognition", None))
        self.groupBoxLiveVideo.setTitle(
            QCoreApplication.translate("MainWindow", u"Live Video", None))
        self.labelLiveVideo.setText(QCoreApplication.translate(
            "MainWindow", u"Loading Video", None))
        self.groupBoxModelSelection.setTitle(
            QCoreApplication.translate("MainWindow", u"Model Selection", None))
        self.labelModelSelection.setText(
            QCoreApplication.translate("MainWindow", u"Model Name:", None))
        self.comboBoxModelSelection.setItemText(
            0, QCoreApplication.translate("MainWindow", u"ResNet50", None))

        self.groupBoxOutput.setTitle(
            QCoreApplication.translate("MainWindow", u"Output", None))
        self.labelDetectedEmoji.setText(QCoreApplication.translate(
            "MainWindow", u"Detected Emotion Emoji:", None))
        self.labelDetectedEmojiPhoto.setText(
            QCoreApplication.translate("MainWindow", u"Emoji Pic", None))
        self.groupBoxDetailedStats.setTitle(
            QCoreApplication.translate("MainWindow", u"Detailed Stats", None))
        self.labelTopEmotion_1.setText(QCoreApplication.translate(
            "MainWindow", u"Top Emotion-1:", None))
        self.labelTopEmotion_2.setText(QCoreApplication.translate(
            "MainWindow", u"Top Emotion-2: ", None))
        self.labelTopEmotion_3.setText(QCoreApplication.translate(
            "MainWindow", u"Top Emotion-3:", None))
    # retranslateUi
