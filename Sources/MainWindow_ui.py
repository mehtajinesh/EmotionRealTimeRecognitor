...
Author: Jinesh Mehta
File Description: This file contains the UI code for the main window.
"""
# -*- coding: utf-8 -*-
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBoxModelSelection.setItemText(
            1, QCoreApplication.translate("MainWindow", u"Inception-v2", None))
        self.comboBoxModelSelection.setItemText(
            2, QCoreApplication.translate("MainWindow", u"Inception-v3", None))

        self.labelUpdatingModel.setText(QCoreApplication.translate(
            "MainWindow", u"Updating Model. Please wait ...", None))
