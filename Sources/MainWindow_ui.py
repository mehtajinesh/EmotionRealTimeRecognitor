...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout = QFormLayout(self.groupBoxDetailedStats)
        self.formLayout.setObjectName(u"formLayout")
        self.labelTopEmotion_1 = QLabel(self.groupBoxDetailedStats)
        self.labelTopEmotion_1.setObjectName(u"labelTopEmotion_1")

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.labelTopEmotion_1)
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.progressBarTopEmotion1)

        self.labelTopEmotion_2 = QLabel(self.groupBoxDetailedStats)
        self.labelTopEmotion_2.setObjectName(u"labelTopEmotion_2")

        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.labelTopEmotion_2)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.progressBarTopEmotion2)

        self.labelTopEmotion_3 = QLabel(self.groupBoxDetailedStats)
        self.labelTopEmotion_3.setObjectName(u"labelTopEmotion_3")

        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.labelTopEmotion_3)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.progressBarTopEmotion3)
