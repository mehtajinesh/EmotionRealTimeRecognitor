...
from constants import HAAR_CASCADE_PATH, RESNET_MODEL_PATH, RESNET_FER_MEAN, RESNET_FER_STD, \
    ...
    INCEPTION_FER_IMG_WIDTH, INCEPTION_FER_IMG_HEIGHT,\
    INCEPTION_FER_MEAN, INCEPTION_FER_STD
from keras.models import load_model
from constants import MODEL_PATH_LIST
...
class LiveVideoThread(QThread):
    ...
    def set_model(self, model_index):
        ...
        print("Setting model...")
        self.model = load_model(MODEL_PATH_LIST[model_index])
        print("Model changed to: ", MODEL_PATH_LIST[model_index])
        self.updatingModel = False
    ...
    def preprocess_input(self, image):
        ...
        if self.model.input_shape[1] == RESNET_FER_IMG_WIDTH:
            ...
            # Resizing images for the trained model
            image = cv2.resize(
                image, (INCEPTION_FER_IMG_WIDTH, INCEPTION_FER_IMG_HEIGHT))
